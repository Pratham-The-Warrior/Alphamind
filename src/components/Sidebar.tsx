...
import { Brain, TrendingUp, PieChart, BarChart3, Settings, ChevronLeft, ChevronRight, Zap } from 'lucide-react';
...
const navigation = [
  ...
  { id: 'portfolio', label: 'Smart Portfolio', icon: PieChart },
  { id: 'markets', label: 'All Markets', icon: TrendingUp },
  { id: 'analytics', label: 'AI Analytics', icon: BarChart3 },
  { id: 'optimizer', label: 'Risk Optimizer', icon: Zap },
    ...
    >
      ...
      <div className="p-6 border-b border-light-border dark:border-dark-border flex items-center justify-between">
        ...
        >
          {!isCollapsed && (
            <div>
              <h1 className="text-lg font-bold text-lime-accent font-editorial">Alpha Mind</h1>
              <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary">AI Wealth Platform</p>
            </div>
          )}
        </motion.div>
        <button
